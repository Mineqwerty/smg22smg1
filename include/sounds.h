...
#define SOUND_ETRIAN_STEP                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x77, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_BONK               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x78, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_HORN               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x79, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_SQUIRREL               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7A, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_PLEASE               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7B, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_FART               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7C, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_WETFART               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x7D, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_MENU_PATCHY          /* 0x7024FF80 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,     0x25, 0xFF, SOUND_DISCRETE)
