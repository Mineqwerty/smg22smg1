...
enum SeqId {
    ...
    SEQ_STREAMED_EMERALD_WOODLANDS,
    SEQ_STREAMED_FUNKY,
    SEQ_STREAMED_BART,
    SEQ_STREAMED_SIMPSONS,
    SEQ_STREAMED_HORN,
    SEQ_STREAMED_SCARY,
    SEQ_STREAMED_STORY_OF_UNDERTALE,
    SEQ_STREAMED_SPORTS,
    SEQ_STREAMED_NOKIA,
    SEQ_STREAMED_SORTING,
    SEQ_STREAMED_HAMSTER,
    SEQ_STREAMED_CHEERS,
    SEQ_STREAMED_JUMPSCARE,
    SEQ_STREAMED_STATIC,
    SEQ_STREAMED_TRAINCAR,
    SEQ_STREAMED_47,
    SEQ_COUNT
};
