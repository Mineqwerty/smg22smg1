...
extern const BehaviorScript bhvEtrianController[];
extern const BehaviorScript bhvEtrianIntro[];
extern const BehaviorScript bhvTreePill[];
extern const BehaviorScript bhvMovingRedCoin[];
