...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 3600, 0, -8000, 0, -90, 0, 0x00000000, bhvEtrianIntro),
		OBJECT(MODEL_NONE, -3599, 0, -6231, 0, -90, 0, 0x00000000, bhvEtrianWarp),
		OBJECT(MODEL_NONE, 2600, 279, -8000, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 2600, 279, -8000),
		TERRAIN(wf_area_1_collision),
		MACRO_OBJECTS(wf_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_STREAMED_EMERALD_WOODLANDS),
