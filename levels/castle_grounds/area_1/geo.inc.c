...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 141, -3905, castle_grounds_dl_Mario__BodyMT_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -494, 0, castle_grounds_dl_Plane_mesh_layer_1),
		GEO_OPEN_NODE(),
