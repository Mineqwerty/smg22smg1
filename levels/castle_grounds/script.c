...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 1273, 150, -1030, 0, 0, 0, (8 << 24) | (8 << 16), bhv1Up),
		OBJECT(MODEL_MARIOS_METAL_CAP, 3960, -494, -3340, 0, 0, 0, (0 << 24) | (0 << 16), bhvMetalCap),
		OBJECT(MODEL_WOODEN_SIGNPOST, 3934, -494, -3106, 0, 0, 0, (9 << 24) | (9 << 16), bhvMessagePanel),
		...
		OBJECT(MODEL_MONTY_MOLE, -3838, -482, -4024, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3838, -628, -4024, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3838, -665, -4024, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3838, -725, -4024, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3723, -264, -3553, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3723, -349, -3553, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3600, -282, -3198, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3600, -319, -3198, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3600, -379, -3198, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3600, -456, -3198, 0, 0, 0, 0x00000000, bhvMontyMole),
		OBJECT(MODEL_MONTY_MOLE, -3600, -541, -3198, 0, 0, 0, 0x00000000, bhvMontyMole),
		...
		OBJECT(MODEL_RED_COIN, -3644, -494, -3731, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 4316, -494, 1411, 0, 0, 0, 0x00000000, bhvRedCoin),
