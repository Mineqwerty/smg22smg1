...
COURSE_ACTS(COURSE_JRB, _(" 3 DONT ACCESS MEMORY OOB"),
       _("OR ELSE")    , _("CAN THE EEL COME OUT TO PLAY?") , _("TREASURE OF THE OCEAN CAVE"),
       _("RED COINS ON THE SHIP AFLOAT")  , _("BLAST TO THE STONE PILLAR")     , _("THROUGH THE JET STREAM"))

COURSE_ACTS(COURSE_CCM, _(" 4 COOL, COOL FOUNTAIN"),
       _("SLID SLIPPIN' AWAY")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
       _("FROSTY SLIDE FOR 8 RED COINS")  , _("SNOWMAN'S LOST HIS HEAD")       , _("WALL KICKS WILL WORK"))

COURSE_ACTS(COURSE_BBH, _(" 5 MONOCHROME MUNICIPALITY"),
       _("THE ENDLESS GREY EXPANSE")            , _("RIDE BIG BOO'S MERRY-GO-ROUND") , _("SECRET OF THE HAUNTED BOOKS"),
...
COURSE_ACTS(COURSE_LLL, _(" 7 REFUGEE ROAD"),
       _("SAY HI TO EVERYONE")            , _("BULLY THE BULLIES")             , _("8-COIN PUZZLE WITH 15 PIECES"),
...
SECRET_STAR(COURSE_PSS, _("   BORT LICENSE PLATES"))
