...
tje wise mistical three:\n\
hi mario you should knwo\n\
that you need a POWER\n\
UP (stonrger)\n\
hack cretaors note:\n\
this pwoer up is \n\
...
deocmp this time so\n\
i made raelly cool stuff\n\
but its alos my first time\n\
btw rom manager still\n\
broke some stuff the\n\
tweak list doesnt work\n\
sometimes..."))
